...
## Cell Structure:
MyJob.Cell.set_CellSize( [20.00, 25.0798] )    # cell size [X,Y] in millimeters
MyJob.Cell.set_MatrixShift( [9.6849, -10.9554] ) # shift by half a cell
...
#   1st WG layer
WG1 = MyJob.Image("H1","PBINTV2H1", sizeXY=[20, 27], shiftXY=[0,0])

## To expose on Layer 2 and more:

WG2 = MyJob.Image("H2", "PBINTV2H3", sizeXY=[20, 27], shiftXY=[0,0])

OMET = MyJob.Image("OMET","PBOMV11", sizeXY=[20, 18], shiftXY=[0,0])
