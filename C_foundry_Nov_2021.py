...
## Cell Structure:
MyJob.Cell.set_CellSize( [20.00, 25.0786] )    # cell size [X,Y] in millimeters
MyJob.Cell.set_MatrixShift( [10.0099-20, -8.6394]) # shift by half a cell
...
for r in [-1,0,1,2]:
     WG2.distribute( [r,1], shiftXY = [0,0])
     WG1.distribute( [r,0], shiftXY = [0,0])
         

# WG2.distribute( [-2,0], shiftXY = [0,0])
# WG2.distribute( [0,0], shiftXY = [0,0])
# WG2.distribute( [-1,0], shiftXY = [0,0])
# WG2.distribute( [1,0], shiftXY = [0,0])

# WG1.distribute( [-2,-1], shiftXY = [0,0])
# WG1.distribute( [0, -1], shiftXY = [0,0])
# WG1.distribute( [-1,-1], shiftXY = [0,0])
# WG1.distribute( [1,-1], shiftXY = [0,0])



OMET.distribute(cellCR= [0,-1] , shiftXY = [-0.45, 1.428])
OMET.distribute(cellCR= [1,-1] , shiftXY = [-0.45, 1.428])
...
MyJob.export('CBR-LITH-B007w20.txt', overwrite=True) 
