...
MyJob.Cell.set_MatrixShift( [9.675, 9.684] ) # shift by half a cell
...
#   1st WG layer
WG1 = MyJob.Image("H1","PBH1V11", sizeXY=[20, 24], shiftXY=[0,0])

## To expose on Layer 2 and more:

WG2 = MyJob.Image("H2", "PBH2V11", sizeXY=[20, 24], shiftXY=[0,0])
...
ZeroLyr.expose_Marks(  marks=[E, EN, ES, W, WN, WS], Energy=14, Focus=0 )   # set Marks Exposure. 

# Layer 1 - Not combine with Zero layer alignment mark exposure
Lyr1 = MyJob.Layer( LayerID="WG1" )
Lyr1.set_PreAlignment( marks=[E, W] ) # choose 2 marks
Lyr1.set_GlobalAlignment( strategy=ALL )
...
MyJob.export('CBR_LITH_ALIGNMENT1.txt', overwrite=True) 
