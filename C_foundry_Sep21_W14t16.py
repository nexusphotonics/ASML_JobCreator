...
WG2.distribute( [-2,0], shiftXY = [-0.00495, -0.0001])
WG2.distribute( [0,0], shiftXY = [-0.00495, -0.0001])
WG2.distribute( [-1,0], shiftXY = [-0.00495, -0.0001])
WG2.distribute( [1,0], shiftXY = [-0.00495, -0.0001])

WG1.distribute( [-2,-1], shiftXY = [-0.00495, 0.0001])
WG1.distribute( [0, -1], shiftXY = [-0.00495, 0.0001])
WG1.distribute( [-1,-1], shiftXY = [-0.00495, 0.0001])
WG1.distribute( [1,-1], shiftXY = [-0.00495, 0.0001])
...
MyJob.export('CBR-LITH-W14T16_n.txt', overwrite=True) 
